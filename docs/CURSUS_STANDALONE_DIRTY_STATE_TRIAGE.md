...
Context: Peh-v2 removed its embedded Cursus package in commit `c53f110`. `/mnt/ai/cursus` is now the standalone source of truth. Peh integrates by bridge/proxy only.
...
| `src/web/index.html` | web UI work | Commit. First-party standalone Cursus UI shell. Not generated and not copied from Peh. |
